...
def get_top_talkers():
    return {"status": "success", "data": cache.get("top_talkers") or []}
...
def get_top_attackers():
    return {"status": "success", "data": cache.get("top_attackers") or []}
...
def get_threat_rankings():
    return {"status": "success", "data": cache.get("threat_rankings") or []}
...
def get_protocols():
    return {"status": "success", "data": cache.get("protocol_statistics") or {}}


@router.get("/ports", response_model=ProtocolStatsResponse, summary="Get Port Stats")
def get_ports():
    return {"status": "success", "data": cache.get("port_statistics") or {}}
