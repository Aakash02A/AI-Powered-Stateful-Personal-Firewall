...
def validate_threat_scoring():
    ...
    scenarios = [
        {"ip": "192.168.1.50", "events": ["port_scan", "port_scan", "brute_force", "block", "block", "block", "block", "block"]},
        {"ip": "10.0.0.99", "events": ["syn_flood"]},
        {"ip": "172.16.0.5", "events": ["block", "block"]},
        {"ip": "8.8.8.8", "events": []},
        {"ip": "45.33.22.11", "events": ["brute_force", "brute_force", "brute_force", "brute_force"]}
    ]
    ...
    for s in scenarios:
        ...
        print(f"{s['ip']:<15} | {events_str:<30} | {score:<6.1f} | {classification:<15}")
