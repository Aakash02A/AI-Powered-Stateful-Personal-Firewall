...
from firewall.models import Alert, Connection, FirewallEvent, Packet
...
class FirewallDatabase:
    ...
    def query_connections(self, limit: int = 100) -> List[dict]:
        ...
        records = (
            ...
            .order_by(ConnectionRecord.creation_time.desc())
            .limit(limit)
            .all()
        )
    ...
    def query_alerts(
        self, severity: str = None, alert_type: str = None, limit: int = 100
    ) -> List[dict]:
        session = self.Session()
