...
class IDSEngine:
    ...
    def _cleanup_old_records(self, record_dict, time_window: int):
        ...
        for key in list(record_dict.keys()):
            if isinstance(record_dict[key], list):
                ...
                record_dict[key] = [t for t in record_dict[key] if isinstance(t, datetime) and t > threshold or (isinstance(t, tuple) and t[0] > threshold)]
    ...
    def analyze_packet(self, packet: Packet) -> List[Alert]:
        ...
        if alert2: alerts.append(alert2)
