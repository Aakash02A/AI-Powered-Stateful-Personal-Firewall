...
def test_brute_force_detection():
    ...
    for _ in range(6):
        p = Packet(timestamp=datetime.now(), src_ip="192.168.1.100", src_port=50000, dst_ip="10.0.0.1", dst_port=22, protocol="TCP", flags="S", size=60)
...
def test_suspicious_port_detection():
    ...
    p = Packet(timestamp=datetime.now(), src_ip="192.168.1.100", src_port=50000, dst_ip="10.0.0.1", dst_port=12345, protocol="TCP", flags="S", size=60)
